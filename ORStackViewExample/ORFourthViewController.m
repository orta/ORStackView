...
- (void)viewDidLoad
{
    ...
    [splitView.leftStack addSubview:left1 withStartMargin:0.0 sideMargin:10.0];
    [splitView.leftStack addSubview:left2 withStartMargin:10.0 sideMargin:5.0];
    [splitView.leftStack addSubview:left3 withStartMargin:10.0 sideMargin:15.0];
    [splitView.rightStack addSubview:right1 withStartMargin:0.0 sideMargin:15.0];
    [splitView.rightStack addSubview:right2 withStartMargin:10.0 sideMargin:10.0];
    [splitView.rightStack addSubview:right3 withStartMargin:10.0 sideMargin:5.0];
}
